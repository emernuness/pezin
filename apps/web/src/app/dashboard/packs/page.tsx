         ...
         <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
               <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Vendas</th>
               ...
               {packs.map((pack) => (
                  <tr key={pack.id}>
                     <td className="px-6 py-4">
                        <div className="flex items-center">
                           <div className="h-10 w-10 flex-shrink-0">
                              <img className="h-10 w-10 rounded-md object-cover" src={pack.previews?.[0]?.url || '/placeholder.png'} alt="" />
                           </div>
                           <div className="ml-4">
                     ...
                     <td className="px-6 py-4 text-sm text-gray-500">
                        {new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(pack.price / 100)}
                     </td>
                     <td className="px-6 py-4 text-sm text-gray-500">
