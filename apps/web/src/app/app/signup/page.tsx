...
export default function SignupPage() {
  ...
  const getDescription = () => {
    return formData.userType === "creator"
      ? "Crie sua conta e comece a monetizar seu conteudo"
      : "Crie sua conta e acesse conteudos exclusivos";
  };
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <Label id="user-type-label">O que voce quer fazer?</Label>
              <div className="grid grid-cols-2 gap-4" role="radiogroup" aria-labelledby="user-type-label">
                <button
                  type="button"
                  role="radio"
                  aria-checked={formData.userType === "consumer"}
                  onClick={() =>
                ...
                <button
                  type="button"
                  role="radio"
                  aria-checked={formData.userType === "creator"}
                  onClick={() =>
