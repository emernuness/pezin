...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[600px] overflow-hidden md:min-h-[700px]">
      ...
      {/* Overlay Gradient: preto 80% (esquerda) → preto 10% (direita) */}
      <div
      ...
      <Container className="relative z-10 flex min-h-[600px] items-center py-16 md:min-h-[700px] md:py-24 lg:py-32">
        <div className="max-w-2xl">
          ...
          <p
            ref={subheadlineRef}
            className="mt-6 text-lg text-[#E0E0E0] md:text-xl"
          >
          ...
          <div ref={ctaRef} className="mt-8 flex flex-col gap-4 sm:flex-row">
            ...
            <Button
              ...
              variant="outline"
              asChild
              className="border-[#D4FF00] bg-transparent text-[#D4FF00] hover:bg-[#D4FF00]/0 hover:text-white"
